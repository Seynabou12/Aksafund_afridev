...
class ParticipationsTableTest extends TestCase
{
    ...
    {
        parent::setUp();
        $config = TableRegistry::getTableLocator()->exists('Participations') ? [] : ['className' => ParticipationsTable::class];
        $this->Participations = TableRegistry::getTableLocator()->get('Participations', $config);
    }
